...
class GroupBox(QtWidgets.QWidget):
    def init(self):
        ...
        uic.loadUi('dashboardScreen_2.ui', self._widget)
        ...
        self.blankWidget = self.hbox.findChild(QWidget, 'widget')
        self.blankText = self.findChild(QTextEdit, 'textEdit') #################################### here
        ...
        self.canvasTrend = self.findChild(QWidget, 'widget')
        self.canvasCloud = self.findChild(QWidget, 'widget_2')
        self.canvasRevs = self.findChild(QWidget, 'widget_4')
        self.canvasBlank = self.findChild(QWidget, 'widget_3')
