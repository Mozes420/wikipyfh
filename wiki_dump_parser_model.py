...
def xml_to_csv(filename):
  ...
  _parent = None
  _current_tag = ''
  page_id = page_title = page_ns = revision_id = timestamp = contributor_id = contributor_name = bytes_var = model = ''
  ...
  def data_handler(data):
    nonlocal output_csv, _current_tag, _parent
    nonlocal page_id,page_title,page_ns,revision_id,timestamp,contributor_id,contributor_name,model
  ...
  def end_tag(tag):
    nonlocal output_csv, _current_tag, _parent
    nonlocal page_id,page_title,page_ns,revision_id,timestamp,contributor_id,contributor_name,bytes_var, model
    ...
    if tag == 'revision':
      ...
      revision_id = timestamp = bytes_var = model = ''
      contributor_id = contributor_name = 'anon user'
  ...
  output_csv.write(csv_separator.join(["page_id","page_title","page_ns","revision_id","timestamp","contributor_id","contributor_name","bytes","model"]))
  output_csv.write("\n")
